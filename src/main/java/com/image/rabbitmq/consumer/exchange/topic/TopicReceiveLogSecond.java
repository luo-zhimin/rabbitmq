 ...
 */
public class TopicReceiveLogSecond {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(TopicReceiveLogSecond.class.getSimpleName() + "等待接收消息...");
        //接收消息
...
//            deliverMessage.getEnvelope().getRoutingKey();
            System.out.println(TopicReceiveLogSecond.class.getSimpleName() + " - " + deliverMessage.getEnvelope().getRoutingKey() + "- 接收消息: " + message);
//            channel.basic
        }, (message) -> {
            System.out.println(TopicReceiveLogSecond.class.getSimpleName() + "接收中断消息：" + message);
        });
    }
}
